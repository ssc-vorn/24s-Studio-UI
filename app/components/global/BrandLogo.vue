...
// TODO(brand): swap this text lockup for the official 24 Seven Studio logo asset
// once it's added to the repo (e.g. `public/brand/logo.svg`), rendered as a
// plain <img :src="..." alt="24 Seven Studio"> at the same size. This text
...
<template>
  <span class="inline-flex items-baseline gap-1.5 leading-none" :class="inverse ? 'text-white' : 'text-ink'">
    ...
    <span class="text-sm font-semibold tracking-[0.02em]">SEVEN</span>
